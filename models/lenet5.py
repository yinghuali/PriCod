...
def LeNet5(x_train, num_classes):
    model = Sequential()
    model.add(Conv2D(filters=6, kernel_size=(5, 5), activation='tanh', input_shape=x_train.shape[1:], padding='same'))
...
def main():
    ...
    model = LeNet5(x_train, num_classes=num_classes)
