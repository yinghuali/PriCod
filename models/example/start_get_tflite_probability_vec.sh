...
python get_tflite_probability_vec.py --path_model './onDevice_models/cifar100_DenseNet201_12.tflite' --path_x '../data/cifar100_x.pkl' --path_save './onDevice_out_vec/cifar100_DenseNet201_12_tflite_vec.pkl'
